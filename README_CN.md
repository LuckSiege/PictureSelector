# PictureSelector 2.0
   ...
   [体验Demo](https://github.com/LuckSiege/PictureSelector/raw/master/app/demo/app_2020_05_10_2330_2.5.4.apk)<br>
...
-[最新版本 v2.5.4](#最新版本)<br>
-[更新日志](https://github.com/LuckSiege/PictureSelector/releases/tag/v2.5.4)<br>
...
## 最新版本
```sh
implementation 'com.github.LuckSiege.PictureSelector:picture_library:v2.5.4'
```
