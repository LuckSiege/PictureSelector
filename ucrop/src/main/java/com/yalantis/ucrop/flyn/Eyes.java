package com.yalantis.ucrop.flyn;
...
public class Eyes {
    ...
    public static void setStatusBarLightMode(Activity activity, int color, boolean isStatus) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            //判断是否为小米或魅族手机，如果是则将状态栏文字改为黑色
            if (MIUISetStatusBarLightMode(activity, isStatus) || FlymeSetStatusBarLightMode(activity, isStatus)) {
                //设置状态栏为指定颜色
