...
[Download APK](https://github.com/LuckSiege/PictureSelector/raw/master/app/demo/app_2020_05_11_2140_2.5.6.apk)<br>
...
## Directory
-[Latest Version v2.5.6](#Version)<br>
-[Update Log](https://github.com/LuckSiege/PictureSelector/releases/tag/v2.5.6)<br>
...
## CustomCamera
If you need to use a custom camera you need to set up```.isUseCustomCamera(true);``` Application implementing interface
```sh
