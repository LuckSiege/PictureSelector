...
public class PictureSelectionModel {
	...
	/**
	 * @param isDoctalkStyle Select style with or without Doctalk enabled
	 * @return
	 */
	public PictureSelectionModel isDoctalkStyle (boolean isDoctalkStyle) {
		selectionConfig.isDoctalkStyle = isDoctalkStyle;
		return this;
	}
		...
		if (!DoubleUtils.isFastDoubleClick()) {
			...
			if (selectionConfig.camera && selectionConfig.isUseCustomCamera) {
				...
				if (selectionConfig.camera) {
					intent = new Intent(activity, PictureSelectorCameraEmptyActivity.class);
				}
				else if (selectionConfig.isWeChatStyle) {
					intent = new Intent(activity, PictureSelectorWeChatStyleActivity.class);
				}
				else if (selectionConfig.isDoctalkStyle) {
					intent = new Intent(activity, PictureSelectorDoctalkActivity.class);
				}
				else {
					intent = new Intent(activity, PictureSelectorActivity.class);
				}
			}
